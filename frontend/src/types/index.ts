 ...
 * qos: 1
 */
export let lobbyMsg = (sessionID: SessionID): MQTTMessage => {
  return {
 ...
 * qos:1
 */
export let gameStartMsg = (sessionID: SessionID): MQTTMessage => {
  return {
 ...
 * qos: 1
 */
export let gameEndMsg = (sessionID: SessionID): MQTTMessage => {
  return {
    topic: `${sessionID}/main`,
    message: {
      senderId: undefined,
 ...
 */
export let playPauseMsg = (sessionID: SessionID): MQTTMessage => {
  return {
 ...
 * qos: 1
 */
export let doubtMs = (sessionID: SessionID): MQTTMessage => {
  return {
    topic: `${sessionID}/controller`,
    message: {
      senderId: "placeholder",
 ...
 */
export let evaluationMsg = (sessionID: SessionID): MQTTMessage => {
  return {
    topic: `${sessionID}/main`,
    message: {
      senderId: undefined,
 ...
 * qos:1
 */
export let drawConfirmMsg = (sessionID: SessionID): MQTTMessage => {
  return {
    topic: `${sessionID}/controller`,
    message: {
      senderId: "placeholder",
